                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Inicio <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index">Menu principal</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-tint"></i>Tipo de sangre <!--<span class="fa fa-chevron-down"></span>--></a>
                    <!-- <ul class="nav child_menu">                      
                  ...
                  <li><a><i class="fa fa-navicon"></i>Tipo usuarios <!--<span class="fa fa-chevron-down"></span>--></a>
                    <!-- <ul class="nav child_menu">                      
                  ...
                  <li><a><i class="fa fa-info-circle"></i>Consulta estudios <!--<span class="fa fa-chevron-down"></span>--></a>
                    <!-- <ul class="nav child_menu">                    
                  ...
                  <li><a><i class="fa fa-file-text"></i>Estudios <!--<span class="fa fa-chevron-down"></span>--></a>
                    <!-- <ul class="nav child_menu">                      
